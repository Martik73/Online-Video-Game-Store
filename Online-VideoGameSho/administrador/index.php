...
if (isset($_SESSION['nombreUser']) && $_SESSION['nombreUser'] != '') {
    // Redirigir al usuario a la página 'bienvenido.php' si ya inició sesión
...
<body>
    ...
    <section>
    <h1>MartisCorp S.A. de C.V.</h1>
        <form name="formInicio" method="post"  window.location.href="bienvenido.php">
            <div>
