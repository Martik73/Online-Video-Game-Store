...
<title>Edición de promociones MartisCorp</title>
...
<body>
    ...
    <br>
    <section>
        <h1>Edición de promociones --MartisCorp--</h1>
        ...
        <h2> Edición de la promoción con ID: -  <?php echo $id ?>  - </h2>
        <h2 class="aviso Alert"> Si NO deseas cambiar la foto, deja el campo VACIO </h2>

        <form enctype="multipart/form-data" class="form" name="forma01" method="post" action="promociones_salvaEdicion.php?id=<?php echo $id ?>" >
            
            <input class="camp" type="text" name="nombre" id="nombre" placeholder="Nombre del promoción" value="<?php echo $nombre?>"/><br>
            <div class="campRaro">Foto del promoción ---<input type="file" id="archivo" name="archivo" />---</div>
            <br>
